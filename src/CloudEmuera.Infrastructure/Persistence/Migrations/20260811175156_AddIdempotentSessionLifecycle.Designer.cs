...
namespace CloudEmuera.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260811175156_AddIdempotentSessionLifecycle")]
    partial class AddIdempotentSessionLifecycle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloudEmuera.Infrastructure.Persistence.IdempotencyRecordRow", b =>
                {
                    ...
                    b.HasIndex("Status", "UpdatedAt")
                        .HasDatabaseName("ix_idempotency_records_status_updated");
                    ...
                    b.ToTable("idempotency_records", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_idempotency_error_code", "error_code IS NULL OR (length(error_code) BETWEEN 1 AND 128 AND instr(error_code, char(0)) = 0)");
                            ...
                            t.HasCheckConstraint("ck_idempotency_status", "status IN ('IN_PROGRESS', 'SUCCEEDED', 'FAILED')");

                            t.HasCheckConstraint("ck_idempotency_terminal_fields", "(status = 'IN_PROGRESS' AND error_code IS NULL AND completed_at IS NULL) OR (status = 'SUCCEEDED' AND error_code IS NULL AND completed_at IS NOT NULL) OR (status = 'FAILED' AND error_code IS NOT NULL AND completed_at IS NOT NULL)");

                            t.HasCheckConstraint("ck_idempotency_time_order", "created_at >= 0 AND updated_at >= created_at AND expires_at > created_at AND (completed_at IS NULL OR completed_at >= updated_at)");
                        });
                });
            ...
            modelBuilder.Entity("CloudEmuera.Infrastructure.Persistence.SessionCreationOperationRow", b =>
                {
                    ...
                    b.Property<long>("ExpectedContentBytes")
                        .HasColumnType("INTEGER")
                        .HasColumnName("expected_content_bytes");

                    b.Property<long>("ExpectedFileCount")
                        .HasColumnType("INTEGER")
                        .HasColumnName("expected_file_count");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_session_creation_operations");

                    b.HasIndex("ActorUserId");

                    b.HasIndex("SessionId")
                        .IsUnique()
                        .HasDatabaseName("ux_session_creation_operations_session");

                    b.HasIndex("StagingPath")
                        .IsUnique()
                        .HasDatabaseName("ux_session_creation_operations_staging_path");

                    b.HasIndex("Status", "UpdatedAt")
                        .HasDatabaseName("ix_session_creation_operations_status_updated");

                    b.ToTable("session_creation_operations", null, t =>
                        {
                            t.HasCheckConstraint("ck_session_creation_operations_actor_id", "substr(actor_user_id, 1, 4) = 'usr_' AND length(actor_user_id) BETWEEN 5 AND 64 AND instr(actor_user_id, char(0)) = 0");

                            t.HasCheckConstraint("ck_session_creation_operations_completion", "(status IN ('COMMITTED', 'FAILED') AND completed_at IS NOT NULL) OR (status NOT IN ('COMMITTED', 'FAILED') AND completed_at IS NULL)");

                            t.HasCheckConstraint("ck_session_creation_operations_counters", "reserved_bytes >= 0 AND expected_file_count >= 0 AND expected_content_bytes >= 0 AND attempt_count >= 0 AND state_version >= 0");

                            t.HasCheckConstraint("ck_session_creation_operations_error", "last_error_code IS NULL OR (length(last_error_code) BETWEEN 1 AND 128 AND instr(last_error_code, char(0)) = 0)");

                            t.HasCheckConstraint("ck_session_creation_operations_id", "substr(id, 1, 5) = 'scop_' AND length(id) BETWEEN 5 AND 64 AND instr(id, char(0)) = 0");

                            t.HasCheckConstraint("ck_session_creation_operations_path", "length(staging_path) BETWEEN 1 AND 512 AND substr(staging_path, 1, 1) <> '/' AND instr(staging_path, char(92)) = 0 AND instr(staging_path, char(0)) = 0 AND instr(staging_path, '//') = 0 AND instr('/' || staging_path || '/', '/./') = 0 AND instr('/' || staging_path || '/', '/../') = 0");

                            t.HasCheckConstraint("ck_session_creation_operations_session_id", "substr(session_id, 1, 5) = 'sess_' AND length(session_id) BETWEEN 5 AND 64 AND instr(session_id, char(0)) = 0");

                            t.HasCheckConstraint("ck_session_creation_operations_status", "status IN ('PREPARED', 'COPYING', 'ROOT_PUBLISHED', 'COMMITTED', 'FAILED')");

                            t.HasCheckConstraint("ck_session_creation_operations_time", "created_at >= 0 AND updated_at >= created_at AND (completed_at IS NULL OR completed_at >= updated_at)");
                        });
                });

            modelBuilder.Entity("CloudEmuera.Infrastructure.Persistence.SessionRootMutationLeaseRow", b =>
                {
                    b.Property<string>("SessionId")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT")
                    ...
                    b.HasKey("SessionId")
                        .HasName("pk_session_root_mutation_leases");

                    b.HasIndex("ActorUserId");

                    b.HasIndex("OperationId")
                        .IsUnique()
                        .HasDatabaseName("ux_session_root_mutation_leases_operation");

                    b.ToTable("session_root_mutation_leases", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_session_root_mutation_leases_session_id", "substr(session_id, 1, 5) = 'sess_' AND length(session_id) BETWEEN 5 AND 64 AND instr(session_id, char(0)) = 0");

                            t.HasCheckConstraint("ck_session_root_mutation_leases_time", "acquired_at >= 0 AND expires_at > acquired_at");
                        });
                });
            ...
            modelBuilder.Entity("CloudEmuera.Infrastructure.Persistence.SessionCreationOperationRow", b =>
                {
                    b.HasOne("CloudEmuera.Infrastructure.Persistence.CloudEmueraUser", "ActorUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_session_creation_operations_actor_user");

                    b.HasOne("CloudEmuera.Infrastructure.Persistence.SessionRow", "Session")
                        .WithOne("CreationOperation")
                        .HasForeignKey("CloudEmuera.Infrastructure.Persistence.SessionCreationOperationRow", "SessionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_session_creation_operations_session");
            ...
            modelBuilder.Entity("CloudEmuera.Infrastructure.Persistence.SessionRootMutationLeaseRow", b =>
                {
                    b.HasOne("CloudEmuera.Infrastructure.Persistence.CloudEmueraUser", "ActorUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_session_root_mutation_leases_actor_user");

                    b.HasOne("CloudEmuera.Infrastructure.Persistence.SessionRow", "Session")
                        .WithOne("MutationLease")
                        .HasForeignKey("CloudEmuera.Infrastructure.Persistence.SessionRootMutationLeaseRow", "SessionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_session_root_mutation_leases_session");
            ...
            modelBuilder.Entity("CloudEmuera.Infrastructure.Persistence.SessionRow", b =>
                {
                    b.Navigation("CreationOperation");

                    b.Navigation("MutationLease");
