...
字体排版替代说明（2026-08-23）：本文中从 Session manifest/部署字体映射解析逻辑 family 的方案已被
P1-S04/ADR-0029 收窄。MVP 只加载当前 Session 选择的产品内置 face，并由 Worker 形成权威物理行；
本文其余结构化交互、样式和媒体语义继续有效。
