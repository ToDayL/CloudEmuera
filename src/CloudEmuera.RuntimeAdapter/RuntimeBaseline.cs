...
/// constructs the native global/save names. P0-02 records these facts only;
/// it does not patch or execute the desktop upstream.
/// </summary>
public static class RuntimeBaseline
{
    ...
    public const string CloudEmueraPatchVersion = "0";
}
