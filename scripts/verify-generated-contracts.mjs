...
const schema = JSON.parse(await read("src/CloudEmuera.Contracts/Realtime/realtime-v1.schema.json"));
...
requireValue(realtimeGenerated === generateRealtimeTypes(schema), "realtime/generated.ts is not reproducible from realtime-v1.schema.json");
