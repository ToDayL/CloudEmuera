...
export function NewSessionPage() {
  ...
  const submit = async (event: FormEvent) => {
    ...
    try {
      const created = await createSession(selected.id, name.trim() || `${selected.name} · 新旅程`, fontSize, lineHeight, undefined, fontFaceId, widthMode, widthMode === "CUSTOM" ? customWidth : null, convertBackslashToYen);
