...
范围修订：本文保留早期 Game 库实施计划和验证记录；浏览器文件写入面及未来沙箱占位等已实现系统的
简化以 [`ADR-0017`](../adr/0017-trusted-self-hosted-mvp-simplification.md) 和 P1-S01 为准。
...
后续步骤：P1-05 API Worker Manager 租约与 epoch；P1-06 Session 创建；P1-10 浏览器游戏库；P1-S01
已收窄浏览器写入面和未实现的沙箱占位
