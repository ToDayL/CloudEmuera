    ...
    SessionCommandReadiness readiness)
{
    public async Task HandleAsync(HttpContext context)
    {
        ...
        if (!HasRequestedSubprotocol(context))
        {
            ...
            await RejectAsync(context, StatusCodes.Status426UpgradeRequired, "REALTIME_PROTOCOL_REQUIRED", "The realtime v1 subprotocol is required.").ConfigureAwait(false);
            return;
        }
