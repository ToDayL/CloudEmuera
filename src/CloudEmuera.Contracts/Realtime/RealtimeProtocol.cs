...
/// P1-S10; this file freezes the v6 envelope and browser commands around it.
/// </summary>
public static class RealtimeProtocol
{
    public const int Version = 6;
    public const string Subprotocol = "cloudemuera.realtime.v6";
    public const string PayloadSchemaVersion = "p1-s10-button-generation";
