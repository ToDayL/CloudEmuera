...
public sealed class InitialMigrationTests
{
    ...
    public async Task EmptyDatabase_MigratesToLatestSchema()
    {
        ...
        Assert.Equal(19, await ScalarIntAsync(scope.Connection, "SELECT COUNT(*) FROM schema_migrations;"));
    }
    ...
    public async Task LatestDatabase_MigrateAgain_IsNoOpAndPreservesRows()
    {
        ...
        Assert.Equal(19, await ScalarIntAsync(verify.Connection, "SELECT COUNT(*) FROM schema_migrations;"));
    }
    ...
    public async Task DatabaseNewerThanBinary_CheckFailsWithoutMutation()
    {
        ...
        Assert.Equal(20, await CountHistoryRowsAsync(database));
    }
