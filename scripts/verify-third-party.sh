...
expected_integration_version="headless-p0.5.3"
...
for required_path in \
  ...
  "$runtime_root/UpstreamHeadless/CloudEmuera.EmueraRuntime.UpstreamHeadless.csproj" \
...
grep -Fq "CloudEmuera modification" "$source_root/Emuera/GlobalStatic.cs"
grep -Fq "CloudEmuera modification" "$source_root/Emuera/Runtime/Config/ConfigData.cs"
grep -Fq "CloudEmuera modification" "$source_root/Emuera/Runtime/Script/Process.cs"
grep -Fq "CloudEmuera modification" "$source_root/Emuera/Runtime/Script/Statements/Instraction.Child.cs"
grep -Fq "System.Drawing.Common\" Version=\"6.0.0" "$repo_root/Directory.Packages.props"
grep -Fq "SkiaSharp\" Version=\"4.151.1" "$repo_root/Directory.Packages.props"
grep -Fq "SkiaSharp.NativeAssets.Linux\" Version=\"4.151.1" "$repo_root/Directory.Packages.props"
grep -Fq "## System.Drawing.Common" "$repo_root/THIRD_PARTY_NOTICES.md"
grep -Fq "## SkiaSharp" "$repo_root/THIRD_PARTY_NOTICES.md"
