...
namespace CloudEmuera.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260809100000_FreezeIdentityModel")]
    partial class FreezeIdentityModel
    {
        /// <inheritdoc />
        protected override void BuildTargetModel(ModelBuilder modelBuilder) => BuildFrozenTargetModel(modelBuilder);

        internal static void BuildFrozenTargetModel(ModelBuilder modelBuilder)
        {
