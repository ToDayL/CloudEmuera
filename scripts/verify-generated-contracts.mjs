...
const schema = JSON.parse(await read("src/CloudEmuera.Contracts/Realtime/realtime-v6.schema.json"));
...
requireValue(realtimeGenerated === generateRealtimeTypes(schema), "realtime/generated.ts is not reproducible from realtime-v6.schema.json");
